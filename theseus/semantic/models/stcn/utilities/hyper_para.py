...
class HyperParameters():
    def parse(self, unknown_arg_ok=False):
        ...
        parser.add_argument('--volume_dir', help='Static training data root', default='../static')
        parser.add_argument('--label_dir', help='Static training data root', default='../static')
