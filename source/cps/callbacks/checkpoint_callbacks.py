...
class TwoStreamCheckpointCallbacks(Callbacks):
    """
    ...
    def save_checkpoint(self, trainer, iters, outname='last'):
        ...
        """
        weights = {
            'model1': trainer.model.model.model1.get_model().state_dict(),
            'model2': trainer.model.model.model2.get_model().state_dict(),
            'optimizer1': trainer.optimizers[0].state_dict(),
            'optimizer2': trainer.optimizers[1].state_dict(),
            'scheduler1': trainer.schedulers[0].state_dict(),
            'scheduler2': trainer.schedulers[1].state_dict(),
            'iters': iters,
