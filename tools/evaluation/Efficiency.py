...
if __name__ == "__main__":
    ...
    try:
        ...
        # )
        cmd = 'docker container run --gpus="device={}" --name {} --rm -v $PWD/inputs/:/home/hcmus/workspace/inputs/ -v $PWD/outputs/:/home/hcmus/workspace/outputs/ {}:latest /bin/bash -c "sh tools/scripts/predict.sh" '.format(
